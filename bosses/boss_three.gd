...
@onready var muzzle7: Marker2D = $Muzzle7
@onready var muzzle8: Marker2D = $Muzzle8
...
func fire_lasers() -> void:
	...
	spawner_component.spawn(muzzle7.global_position)
	spawner_component.spawn(muzzle8.global_position)
	#laserboss_sfx.play()
